...
function fillDropdownObj(item) {
    ...
    el.value = item //item bliver til en string
    el.kommune = item
...
function inputChanged(key) {
    ...
    const kommune = selectedOption.value //kan ikke bruges laves op til en string så det virker det ikke så skriver den [Object : object]
    console.log(kommune)
...
pbFetchKommuner.addEventListener('click', inputChanged)
